...
filters_config = {'anonymous':
                      [{'path': os.path.join(wkdir, "filters/msk1.png"),
                        'anno_path': os.path.join(wkdir, "filters/msk2.csv"),
                        'morph': True, 'animated': False, 'has_alpha': True}], }


def getLandmarks(img):
    mp_face_mesh = mp.solutions.face_mesh
    selected_keypoint_indices = [127, 93, 58, 136, 150, 149, 176, 148, 152, 377, 400, 378, 379, 365, 288, 323, 356, 70,
                                 63, 105, 66, 55,
                                 285, 296, 334, 293, 300, 168, 6, 195, 4, 64, 60, 94, 290, 439, 33, 160, 158, 173, 153,
                                 144, 398, 385,
                                 387, 466, 373, 380, 61, 40, 39, 0, 269, 270, 291, 321, 405, 17, 181, 91, 78, 81, 13,
                                 311, 306, 402, 14,
...
def load_filter(filter_name="anonymous"):
    ...
    for filter in filters:
        ...
        multi_filter_runtime.append(temp_dict)  # here
    ...
    while True:
        ...
        if not ret:
            ...
            points2Next, st, err = cv2.calcOpticalFlowPyrLK(img2GrayPrev, img2Gray, points2Prev,
                                                            np.array(points2, np.float32), **lk_params)
